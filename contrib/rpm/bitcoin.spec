...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 27265
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 27267
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 27265
	%{_sbindir}/semanage port -d -p tcp 27267
