...
"""Verify that starting doorcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start doorcoin with -h for help text")
        ...
        self.log.info("Start doorcoin with -version for version information")
