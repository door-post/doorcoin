...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s doorcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  doorcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded doorcoin transaction") + "\n" +
              "  doorcoin-tx [options] -create [commands]   " + _("Create hex-encoded doorcoin transaction") + "\n" +
              "\n";
