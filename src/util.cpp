...
const char * const BITCOIN_CONF_FILENAME = "doorcoin.conf";
const char * const BITCOIN_PID_FILENAME = "doorcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Doorcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Doorcoin";
#else
    // Unix
    return pathRet / ".doorcoin";
#endif
#endif
}
