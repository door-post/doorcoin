...
* doorcoin.conf: contains configuration settings for doorcoind or doorcoin-qt
* doorcoind.pid: stores the process id of doorcoind while running
...
* debug.log: contains debug information and general logging generated by doorcoind or doorcoin-qt
