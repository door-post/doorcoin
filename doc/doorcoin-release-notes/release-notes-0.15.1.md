Doorcoin Core version *0.15.1* is now available from:

  <https://download.doorcoin.org/doorcoin-0.15.1/>
...
A number of changes to the way Doorcoin Core deals with peer connections and invalid blocks
